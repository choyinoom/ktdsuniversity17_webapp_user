...
value='/resources/css/footer.css'/>">
				...
				<div id="noEmail_modal" style="display : none; background: #fefefe; width: 100px;">
					...
					<div style="display:flex; justify-content: center; padding : 10px 50px 0px 50px;">본 사이트에 게재된 모든 전자메일
						(E-MAIL) 주소를 무단으로 수집하는 것을 거부하며, 이를 위반시 정보통신망법에 의해 형사처벌됨을 유념하시기 바랍니다.</div>
					<a class="modal_close_btn" style="position: absolute; top: 10px; right: 10px; cursor: pointer;"><img
